...
class YetiVision:
    ...
    def __init__(self):
        ...
        self.__hsv_threshold_hue = np.array([58.273381294964025, 180.0])
        self.__hsv_threshold_saturation = np.array([171.98741007194246, 255.0])
        self.__hsv_threshold_value = np.array([133.00359712230215, 255.0])
    ...
    def process(self, inframe, outframe):
        ...
        def formatContour(contour):
            x,y,w,h = cv2.boundingRect(np.array(contour[0])) # Get the stats of the contour including width and height
