...
public class TurnThenForwardThenShootCommandGroup extends SequentialCommandGroup{
    ...
    public TurnThenForwardThenShootCommandGroup(ShooterSubsystem shooterSubsystem, HopperSubsystem hopperSubsystem, NeckSubsystem neckSubsystem, DrivetrainSubsystem drivetrainSubsystem, IntakeSubsystem intakeSubsystem, Limelight limelight) {
        super();
        addCommands(
